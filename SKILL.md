...
## Mission
Deliver implementation-ready design-system guidance for Verve Dent that can be applied consistently across marketing site interfaces.
...
- Typography scale: `font.size.xs=12px`, `font.size.sm=13px`, `font.size.md=14px`, `font.size.lg=16px`, `font.size.xl=18px`, `font.size.2xl=22px`, `font.size.3xl=24px`, `font.size.4xl=28px`
